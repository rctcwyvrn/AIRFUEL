...
100–150 m) — edit the generator and re-run it; never hand-edit the tscn. Hallway cross-section: 24 wide × 30 tall — floor, two full
walls, and a roof with `cast_shadow = 0` (the corridor trick: enclosed
but still sunlit). Elevation changes subdivide each straight into five parts —
